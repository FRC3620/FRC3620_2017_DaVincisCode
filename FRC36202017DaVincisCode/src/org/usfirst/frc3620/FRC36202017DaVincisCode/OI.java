...
public class OI {
    ...
    public JoystickButton shiftGearButton;
    ...
    public OI() {
        ...
        shiftGearButton = new JoystickButton(operatorJoystick, 3);
        shiftGearButton.whenPressed(new ShiftGearWithVisionCommand());

        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("RunShooterCommand", new RunShooterCommand());
        SmartDashboard.putData("SwitchBackAndForth", new SwitchBackAndForth());
