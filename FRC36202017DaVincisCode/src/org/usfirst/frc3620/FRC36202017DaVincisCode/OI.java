...
public class OI {
	...
	public JoystickButton shiftUpButton, shiftDownButton, shiftClimberButton, switchBackAndForthButton;
    ...
    public OI() {
        ...
        shiftClimberButton.whenPressed(new ShiftIntoClimbing());
...
//        rotateGearDownButton.whenPressed(new RotateGearDownCommand());
        ...
        shiftOutOfClimberButton = new JoystickButton(operatorJoystick, 5);
        shiftOutOfClimberButton.whenPressed(new ShiftOutOfClimbing());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        operatorDpad.down().cancelWhenActive(huntForRopeCommand);
