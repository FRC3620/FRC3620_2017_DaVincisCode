...
//        CameraServer.getInstance().startAutomaticCapture();
		...
		autonomousLaneCommand = new AutonomousCommand();
...
//		}
		...
		if (autonomousLaneCommand != null) {
			logger.info("Starting autonomous {}", autonomousLaneCommand.getClass().getName());
			autonomousLaneCommand.start();
		}
	}
	...
	public void testInit() {
		...
		// test starts running.
		if (autonomousLaneCommand != null)
			((Command) autonomousLaneCommand).cancel();
