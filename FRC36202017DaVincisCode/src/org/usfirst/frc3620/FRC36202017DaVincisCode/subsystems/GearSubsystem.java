...
public class GearSubsystem extends Subsystem {
	...
	public void shiftGearToPeg(){
		if(isBlobThere()){
			if((getTargetCenter()+3)<getPegLocation()){
				slideMotor(-.5);
			}
			else if((getTargetCenter()-3)>getPegLocation()){
				slideMotor(.5);
			}
			else{
	...
	public boolean gearIsAligned(){
		if ((getTargetCenter()+3)>getPegLocation() && (getTargetCenter()-3)<getPegLocation()){
			return true;
		}
		else{
			return false;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
        ...
        //setDefaultCommand(new ShiftGearToPegCommand());
