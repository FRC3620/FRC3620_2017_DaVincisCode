...
public class ShooterSubsystem extends Subsystem {
  ...
  Timer timer = new Timer();
    ...
    public void updatePIDFromDashboard(){
        ...
        double shooterF= edu.wpi.first.wpilibj.Preferences.getInstance().getDouble("shooterF", .1097);
        shooterCANTalon2.setPID(shooterP, shooterI, shooterD);
        shooterCANTalon2.setF(shooterF);
        logger.info ("setting up CAN talon, PIDF = {} {} {} {}", shooterCANTalon2.getP(), shooterCANTalon2.getI(), shooterCANTalon2.getD(), shooterCANTalon2.getF());
    }
    ...
    public void updateDashboard(){
    	if (Robot.canDeviceFinder.isSRXPresent(shooterCANTalon2)) {
        	...
        	SmartDashboard.putNumber("ShooterF", shooterCANTalon2.getF());
