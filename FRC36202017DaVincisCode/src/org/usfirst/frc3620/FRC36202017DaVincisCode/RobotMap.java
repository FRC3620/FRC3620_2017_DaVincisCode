...
public class RobotMap {
    ...
    public static DigitalInput gearSubsystemSpokeSensor;
    public static DigitalInput gearSubsystemPlacementSensor;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        intakeSubsystemIntakeTalon = new Spark(8);
        LiveWindow.addActuator("IntakeSubsystem", "Intake Talon", (Spark) intakeSubsystemIntakeTalon);
        
        gearSubsystemPlacementSensor = new DigitalInput(9);
        LiveWindow.addSensor("IntakeSubsystem", "Placement Sensor", gearSubsystemPlacementSensor);
